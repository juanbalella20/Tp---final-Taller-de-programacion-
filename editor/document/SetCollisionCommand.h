#ifndef EDITOR_SET_COLLISION_COMMAND_H
#define EDITOR_SET_COLLISION_COMMAND_H
 ...
 * colision del Map. Un trazo completo de la herramienta Colision (press + drags)
 * se guarda como UN solo SetCollisionCommand, igual que SetTilesCommand para los
 * gids: un gesto entero es una unica operacion de undo.
 *
...
#endif  // EDITOR_SET_COLLISION_COMMAND_H
